...
//
// libtabnaschess is the chess format parser as a C shared library, one of
...
import (
	...
	plug "github.com/tabnas/chess/go"
)

const (
	templateVersion = "v1"
	libName         = "libtabnaschess"
	formatName      = "chess"
	valueOut        = true
)
...
// newParser builds one engine with the chess grammar installed
...
// parseWith answers whether src is in the chess language — and,
